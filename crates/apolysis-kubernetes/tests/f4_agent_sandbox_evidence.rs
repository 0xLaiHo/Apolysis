...
use apolysis_kubernetes::{f4_agent_sandbox_evidence_from_metadata, KubernetesMetadata};
use apolysis_validation::F4RuntimeAdapterEvidenceSource;

#[test]
fn kubernetes_metadata_becomes_f4_agent_sandbox_evidence() {
    ...
    let evidence = f4_agent_sandbox_evidence_from_metadata(
        &metadata,
        "session-k8s-gvisor",

...
use apolysis_visibility::{
    assess_visibility, f4_gvisor_metadata_evidence_from_assessment, RuntimeVisibilityProfile,
    VisibilityInput,
};

#[test]
fn gvisor_visibility_assessment_becomes_f4_metadata_evidence() {
    ...
    let evidence = f4_gvisor_metadata_evidence_from_assessment(
        &assessment,

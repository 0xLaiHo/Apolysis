...
use apolysis_validation::{
    evaluate_production_hardening_release_promotion_policy, release_contracts,
    ProductionHardeningReleasePromotionChannel, ProductionHardeningReleasePromotionPolicyEvidence,
    ProductionHardeningReleasePromotionRequest,
};
...
#[test]
fn production_hardening_release_promotion_policy_approves_digest_locked_production_release() {
    let report = evaluate_production_hardening_release_promotion_policy(
        promotion_request(),
        promotion_evidence(),
    );
    ...
    assert_eq!(
        approval.channel,
        ProductionHardeningReleasePromotionChannel::Production
    );
...
#[test]
fn production_hardening_release_promotion_policy_rejects_mutable_or_underprotected_release() {
...
fn promotion_request() -> ProductionHardeningReleasePromotionRequest {
    ProductionHardeningReleasePromotionRequest {
        promotion_id: "promote-apolysisd-2026-06-24".to_string(),
        channel: ProductionHardeningReleasePromotionChannel::Production,
        source_tag: "production-hardening-registry-20260624".to_string(),
...
fn promotion_evidence() -> ProductionHardeningReleasePromotionPolicyEvidence {
    ProductionHardeningReleasePromotionPolicyEvidence {
        release_manifest_sha256: RELEASE_SHA.to_string(),
...
fn release_manifest() -> Value {
    json!({
        "schema": release_contracts::PRODUCTION_HARDENING_RELEASE_MANIFEST_SCHEMA,
        "phase": release_contracts::PRODUCTION_HARDENING_RELEASE_MANIFEST_PHASE,
        "signing": {
            "keyMode": "external",
        ...
        "files": [
            {"path": release_contracts::PRODUCTION_HARDENING_RELEASE_PAYLOAD_ARTIFACT, "sha256": "3333333333333333333333333333333333333333333333333333333333333333", "size": 1},
            {"path": release_contracts::PRODUCTION_HARDENING_DAEMON_IMAGE_ARTIFACT, "sha256": "4444444444444444444444444444444444444444444444444444444444444444", "size": 1},
            {"path": release_contracts::PRODUCTION_HARDENING_SBOM_ARTIFACT, "sha256": "5555555555555555555555555555555555555555555555555555555555555555", "size": 1},
            {"path": release_contracts::PRODUCTION_HARDENING_PROVENANCE_ARTIFACT, "sha256": "6666666666666666666666666666666666666666666666666666666666666666", "size": 1}
        ]
    })
}
...
fn registry_attachment() -> Value {
    json!({
        "schema": release_contracts::PRODUCTION_HARDENING_REGISTRY_ATTACHMENT_SCHEMA,
        "phase": release_contracts::PRODUCTION_HARDENING_REGISTRY_ATTACHMENT_PHASE,
        "registry": {
            "implementation": "registry:2",
            "repository": "apolysisd",
            "tag": "production-hardening-registry-20260624",
            "imageDigest": DIGEST,
        ...
        "registryObservedState": {
            "tagsAfterSbom": {
                "tags": [
                    "production-hardening-registry-20260624",
...
fn archive_manifest() -> Value {
    json!({
        "schema": release_contracts::PRODUCTION_HARDENING_IMMUTABLE_ARCHIVE_SCHEMA,
        "phase": release_contracts::PRODUCTION_HARDENING_IMMUTABLE_ARCHIVE_PHASE,
        "archive": {
        ...
        "artifacts": [
            {"path": "apolysis-production-hardening-release-manifest.json", "sha256": RELEASE_SHA, "size": 1, "mode": "0444"},
            {"path": "apolysis-production-hardening-registry-attachment.json", "sha256": REGISTRY_SHA, "size": 1, "mode": "0444"},
            {"path": "apolysis-production-hardening-apolysisd-image.tar", "sha256": "4444444444444444444444444444444444444444444444444444444444444444", "size": 1, "mode": "0444"}
        ]
    })
}

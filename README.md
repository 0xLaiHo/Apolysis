...
for GitHub secret/variable setup, a final provider completion gate that binds
...
workflow readiness auditing for the remaining GitHub Actions setup. The

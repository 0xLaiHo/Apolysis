...
inspect/ensure handoff to live signing, a final provider completion gate that
binds that readiness audit to a passing final external provider bundle, a
...
handoff to live signing. The remaining F5 production-provider gap is real
cloud KMS or external hardware HSM signing evidence.

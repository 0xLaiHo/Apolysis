...
retention windows, rollback tags, and bounded registry access principals.
...
production registry retention and access controls.
...
| F5 | Production Hardening: DaemonSet privilege budget, multi-tenant storage/query/retention metadata, mTLS/RBAC, signed artifacts, SBOM/provenance, Helm, registry/archive/promotion policy validation, service-mesh identity policy, operator, large-scale chaos and performance testing | 🚧 **In Progress** |

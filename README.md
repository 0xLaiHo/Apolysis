...
archive policy gate, and a live Istio service-mesh admission/handshake
evidence gate.
...
WORM/object-lock archive policy validation, and live Istio service-mesh

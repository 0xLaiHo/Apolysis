...
live-provider evidence source, plus a final provider completion gate that binds
...
provider readiness audit with live-provider fixture rejection, a final provider
completion gate, a manual final provider evidence workflow, and a final provider
bundle environment preparation helper with workflow bundle assembly, retained
provider artifact package handoff, and retained provider workflow alternatives.

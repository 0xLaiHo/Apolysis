...
(( readme_lines <= 140 )) || fail "README.md is too long for the concise project front door"
(( readme_zh_lines <= 140 )) || fail "README.zh-CN.md is too long for the concise project front door"

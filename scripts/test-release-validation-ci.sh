...
require_contains "$makefile" "test-audit-write-budget:"
require_contains "$makefile" "test-offline-hash-chain-verify:"
require_contains "$makefile" "test-timeline-shipping:"
require_contains "$makefile" "test-codex-mismatch-demo:"
require_contains "$makefile" "test-codex-live-demo-runbook:"
require_contains "$makefile" "test-codex-live-demo-public-assets:"
require_contains "$makefile" "test-codex-live-demo-launch-blog:"
require_contains "$makefile" "test-codex-live-demo-final-assets:"
...
require_contains "$workflow" "make test-jsonl-schema-contract"
require_contains "$workflow" "make test-release-artifacts"
require_contains "$workflow" "make test-release-signing"
require_contains "$workflow" "make test-release-artifact-dry-run"
require_contains "$workflow" "make test-signed-release-artifact-dry-run"
require_contains "$workflow" "make test-release-publication-readiness"
require_contains "$workflow" "make test-community-surface"
require_contains "$workflow" "make test-codex-mismatch-demo"
require_contains "$workflow" "make test-codex-live-demo-runbook"
require_contains "$workflow" "make test-codex-live-demo-public-assets"
require_contains "$workflow" "make test-codex-live-demo-launch-blog"
require_contains "$workflow" "make test-codex-live-demo-final-assets"
require_contains "$workflow" "make test-intent-correlation"
require_contains "$workflow" "make test-audit-write-budget"
require_contains "$workflow" "make test-offline-hash-chain-verify"
...
require_contains "$workflow" "name: release-validation-preflight-evidence"
require_contains "$workflow" "target/release-validation-ci/preflight/green/apolysis-release-validation-preflight-report.json"
require_contains "$workflow" "target/release-validation-ci/preflight/green/apolysis-release-validation-evidence-index.json"
require_contains "$workflow" "name: release-validation-final-signoff-evidence"
require_contains "$workflow" "target/release-validation-ci/final-signoff"
require_contains "$workflow" "name: release-validation-production-hardening-evidence"
require_contains "$workflow" "target/release-validation-ci/production-hardening"

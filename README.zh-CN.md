...
| F5 | Production Hardening：DaemonSet privilege budget、multi-tenant storage、mTLS/RBAC、signed artifacts、SBOM/provenance、Helm、registry/archive validation、operator、大规模 chaos/performance testing | 🚧 **进行中** |

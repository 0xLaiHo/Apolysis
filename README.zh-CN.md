...
qualification gate、Vultr VKE 3-node cluster readiness gate、用于 final-bundle managed service-mesh evidence 的 Vultr VKE Istio live provider qualification path、带 live-provider fixture rejection 的 final provider readiness audit、final provider completion gate、手动 final provider evidence workflow、

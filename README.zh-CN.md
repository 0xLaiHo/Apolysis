...
validation 和 release supply-chain validation。
...
| F5 | Production Hardening：DaemonSet privilege budget、multi-tenant storage、mTLS/RBAC、signed artifacts、SBOM/provenance、operator、大规模 chaos/performance testing | 🚧 **进行中** |

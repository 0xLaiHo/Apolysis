...
qualification gate、Vultr VKE 3-node cluster readiness gate、final provider readiness audit、手动 final provider evidence workflow、
final provider bundle environment preparation、workflow bundle assembly 和 retained provider artifact package handoff。

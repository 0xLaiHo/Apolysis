...
signing evidence，以及封装 final external-provider bundle builder 的 F6 evidence package
gate；正式 regulated release 前仍需要 external WORM/object-lock、immutable registry 和
managed-mesh evidence decision。

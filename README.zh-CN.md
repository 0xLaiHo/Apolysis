...
retention/access control 的 release promotion policy validation、KMS/HSM
...
Lock API execution validation 和 live Istio service-mesh admission/handshake
validation。

...
final provider bundle environment preparation、workflow bundle assembly、retained provider artifact package handoff 和 retained signing-provider workflow alternatives。
